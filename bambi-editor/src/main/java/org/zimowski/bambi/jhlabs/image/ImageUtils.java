...
public abstract class ImageUtils {
    ...
    public static BufferedImage createCompatibleImage(BufferedImage src) {
    	return ImageUtils.createCompatibleImage(src, null, null, null);
    }
    
	public static BufferedImage createCompatibleImage(
			BufferedImage src, ColorModel dstCM, Integer width, Integer height) {
		...
		int dstWidth = (width == null ? src.getWidth() : width);
		int dstHeight = (height == null ? src.getHeight() : height);

		WritableRaster r = dstCM.isCompatibleSampleModel(src.getSampleModel()) ? src
				.getRaster()
				.createCompatibleWritableRaster(dstWidth, dstHeight) : dstCM
				.createCompatibleWritableRaster(dstWidth, dstHeight);
